...
const PotCard = () => {
  const {
    ...
    nftPrizeRounds = { addresses1: [], addresses2: [] }, // Default to empty arrays for addresses1 and addresses2
    fetchAllNftPrizeRounds, // Fetch function for NFT prize rounds
  } = useAppContext();
  ...
  const handleRefreshClick = () => {
    ...
    setIsSpinning(true);
    fetchAllNftPrizeRounds(); // Refresh NFT prize rounds
  ...
  const addresses1 = nftPrizeRounds?.addresses1 || [];
  const addresses2 = nftPrizeRounds?.addresses2 || [];
