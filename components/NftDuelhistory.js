...
const PotCard = () => {
  const {
    ...
    nftPrizeRounds = [], // Use nftPrizeRounds instead of miniGameNFTRounds
  ...
  const filteredRounds = showOnlyConnected
    ? nftPrizeRounds.filter(round => round.winner === connectedWalletAddress || round.loser === connectedWalletAddress)
    : nftPrizeRounds;
